package cn.jcyh.doorbelldemo.function.presenter;//package com.szjcyh.demo.function.presenter;
//
...
//import com.szjcyh.demo.constant.AVChatExitCode;
...
// */
//public class DoorbellVideoPresenter2 extends BasePresenter<DoorbellVideoContract.View, DoorbellVideoContract.Model> implements DoorbellVideoContract.Presenter {
...
//        AVChatManager.getInstance().setupLocalVideoRender(IVideoRende.r render, boolean mirror, int scalingType);
////设置视频采集模块
...
//
//        mHandler = new MyHandler(DoorbellVideoPresenter2.this);
...
//        private WeakReference<DoorbellVideoPresenter2> mWeakReference;
//
//        MyHandler(DoorbellVideoPresenter2 presenter) {
...
//            DoorbellVideoPresenter2 presenter = mWeakReference.get();
