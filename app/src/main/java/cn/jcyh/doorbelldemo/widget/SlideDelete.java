...
public class SlideDelete extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int deleteWidth = measureDeleteWidth(widthMeasureSpec);
//        int deleteWidth = MeasureSpec.makeMeasureSpec(layoutParams.width, MeasureSpec.EXACTLY);
    ...
    private int measureDeleteWidth(int widthMeasureSpec) {
        int width = 0;
    ...
    private class MyDrawHelper extends ViewDragHelper.Callback {
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            if (changedView == mContent) { // 如果移动的是mContent
                ...
                mContent.layout(tempContentLeft, 0, left, mContentHeight);
            }
        }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (adx > 20) {
                    getParent().requestDisallowInterceptTouchEvent(true);//侧滑
                } else {
