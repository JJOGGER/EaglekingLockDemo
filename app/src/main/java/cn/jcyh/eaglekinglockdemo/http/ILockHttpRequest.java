...
interface ILockHttpRequest<T> {
    ...
    void auth(String userName, String pwd, final OnHttpRequestCallback<T> listener);

    void syncData(String clientId, long lastUpdateDate, String accessToken, final OnHttpRequestCallback<T> listener);

    void initLock(InitRequestData initRequestData, final OnHttpRequestCallback<T> listener);
