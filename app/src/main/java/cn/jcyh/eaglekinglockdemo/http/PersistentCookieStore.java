...
class PersistentCookieStore {
    ...
    public void add(HttpUrl url, Cookie cookie) {
        ...
        prefsWriter.putString(url.host(), encodeCookie(new SerializableHttpCookie(cookie)));
        prefsWriter.apply();
        String string = cookiePrefs.getString(url.host(), "");
        Timber.e("-------save:" + string);
    }
