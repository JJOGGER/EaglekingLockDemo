...
public class FileUtil {
    private static final String FILE_NAME = "jcyh";
    private static final String RECORD_FILE_PATH = FILE_NAME + File.separator + "record";//猫眼推送图片
    ...
    public static String getBaseRecordFileSrc() {
        ...
        return sdCardPath == null ? null : sdCardPath + RECORD_FILE_PATH;
    }

    /**
     * 猫眼图片/视频路径
     *
     * @return record/doorbellid/yyyyMMdd
     */
    public static String getDoorBellRecordFileSrc(String doorbellID) {
        String baseRecordFileSrc = getBaseRecordFileSrc();
        if (TextUtils.isEmpty(baseRecordFileSrc)) {
            return null;
        } else {
            return baseRecordFileSrc
                    + File.separator
                    + doorbellID;
        }
    }
