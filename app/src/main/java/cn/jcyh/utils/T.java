...
public class T {
    ...
    public static void show(String str) {
        if (toast == null) {
            toast = Toast.makeText(Utils.getApp(), str, Toast.LENGTH_SHORT);
        } else {
            toast.setText(str);
        }
        toast.show();
    ...
    public static void show(int str) {
        if (toast == null) {
            toast = Toast.makeText(Utils.getApp(),
    ...
    public static void show(int resId, int code) {
        String str = Utils.getApp().getString(resId);
        if (toast == null) {
            toast = Toast.makeText(Utils.getApp(), str + String.valueOf(code), Toast.LENGTH_SHORT);
        } else {
            toast.setText(str + String.valueOf(code));
        }
        toast.show();
    }
