...
//                this.ttLockAPI.readDeviceInfo((ExtendedBluetoothDevice)null, this.lockVersion, this.aesKeyStr);
//                break;
//            case 2:
...
//            case 1:
//                this.ttLockAPI.searchDeviceFeature((ExtendedBluetoothDevice)null, 0, this.lockVersion, this.adminPs, this.unlockKey, this.lockFlagPos, this.aesKeyStr);
//                break;
//            case 2:
//                this.ttLockAPI.enterDFUMode((ExtendedBluetoothDevice)null, 0, this.lockVersion, this.adminPs, this.unlockKey, this.lockFlagPos, this.aesKeyStr);
//                break;
//            case 3:
//                this.recoveryData();
//                break;
...
//                break;
//            case 37:
//                this.ttLockAPI.getOperateLog((ExtendedBluetoothDevice)null, this.lockVersion, this.aesKeyStr, this.timezoneOffset);
//                break;
//            case 67:
//                this.ttLockAPI.setLockTime((ExtendedBluetoothDevice)null, 0, this.lockVersion, this.unlockKey, System.currentTimeMillis(), this.lockFlagPos, this.aesKeyStr, this.timezoneOffset);
//        }
//
//    }
//
...
//            public void run() {
//                DeviceFirmwareUpdateApi.this.ttLockAPI.connect(lockmac);
//            }
//        });
//    }
//
...
//        if(BluetoothLeService.mConnectionState == 2) {
//            this.ttLockAPI.recoveryData((ExtendedBluetoothDevice)null, 0, this.lockVersion, this.adminPs, this.unlockKey, this.lockFlagPos, op, json, this.aesKeyStr, this.timezoneOffset);
//        } else {
